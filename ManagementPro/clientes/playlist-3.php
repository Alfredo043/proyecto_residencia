        ...
        <div class="menutabs">
          <div class="check-video">
            <a href="#op1" id="btn2" class="link"
              ...
              Optimización de Menús</a
            >
          </div>
          <div class="check-video">
            <a href="#op2" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>2.
              Cotizaciones</a
            >
          </div>
          <div class="check-video">
            <a href="#op3" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>3. Alta y
              venta de productos a Granel</a
            >
          </div>
          <div class="check-video">
            <a href="#op4" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>4.
              Configuración descuentos por volumen</a
            >
          </div>
          <div class="check-video">
            <a href="#op5" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>5. Generar
              ventas a crédito</a
            >
          </div>
          <div class="check-video">
            <a href="#op6" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>6. Cobro de
              ventas a crédito</a
            >
          </div>
          <div class="check-video">
            <a href="#op7" id="btn2" class="link"
              ><i class="tamañoicono fa-solid fa-circle-play"></i>7. Logo en el
              formato de ticket</a
            >
          </div>
        </div>
      ...
      <section id="contenedor_tabs">
        <article id="op1">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/kQ-PATBDB48"
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Aprende a restringir y optimizar los menús que más utilizas a
              través de permisos de usuarios (catálogos, ventas, inventarios y
              finanzas).
            </p>
          </div>
        </article>
        <article id="op2">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/S-YT1v7E4NE"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Conoce la forma mas sencilla de realizar cotizaciones en el punto
              de venta y como realizar el cobro.
            </p>
          </div>
        </article>
        <article id="op3">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/AIST1QPsRWg"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Aprende a dar de alta productos que vendes a Granel en el punto de
              venta.
            </p>
          </div>
        </article>
        <article id="op4">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/3FDN7tW6GfA"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Conoce la forma de como configurar descuentos por volumen en el
              punto de venta.
            </p>
          </div>
        </article>
        <article id="op5">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/vfhBz9wErLA"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Aprende a aplicar ventas a credito desde Managementpro | RETAIL.
            </p>
          </div>
        </article>
        <article id="op6">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/ARz8x6ssCh0"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Aprende a realizar el cobro de las ventas a crédito desde
        ...
        <article id="op7">
          <div id="contenedoryoutube">
            <iframe
              src="https://www.youtube.com/embed/C2_wJTZtazA"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          <div class="descripcion">
            ...
            <hr />
            <p>
              Conoce la forma de como agregar tu logo en tu formato de ticket.
              Versión Retail!
            </p>
          </div>
        </article>
