<?php
    ...
    if($TipoUsuario==''){
        echo 'Seleciona al menos un tipo de usuario para mostrar el curso';
        return;
    }
    ...
    try{
        ...
        $query = "";
        $query .= "DELETE FROM Curso_Tipo_Usuario WHERE Cr_Cve_Curso = '$IdCurso' ";
        if(mysqli_query($conn, $query)){
            //echo "OK-Datos guardados correctamente";
        }else{
